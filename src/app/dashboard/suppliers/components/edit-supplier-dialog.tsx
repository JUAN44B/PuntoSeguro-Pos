...
export default function EditSupplierDialog({ open, onOpenChange, supplier, onSupplierUpdate }: EditSupplierDialogProps) {
  const [formData, setFormData] = React.useState<Supplier>(supplier);
